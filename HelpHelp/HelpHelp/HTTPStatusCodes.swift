...
// MARK: - 1xx Informational
	...
	static var Information:Range<HTTPStatusCode.RawValue> {
		get {
			return Range(start: HTTPStatusCode.Continue_100.rawValue, end: HTTPStatusCode.Processing_102.rawValue)
		}
	}
...
// MARK: - 2xx Success
	...
	static var Success:Range<HTTPStatusCode.RawValue> {
		get {
			return Range(start: HTTPStatusCode.OK_200.rawValue, end: HTTPStatusCode.IMUsed_226.rawValue)
		}
	}
...
// MARK: - 3xx Redirection
	...
	static var Redirection:Range<HTTPStatusCode.RawValue> {
		get {
			return Range(start: HTTPStatusCode.MultipleChoices_300.rawValue, end: HTTPStatusCode.PermanentRedirect_ResumeIncomplete_308.rawValue)
		}
	}
...
// MARK: - 4xx Client-Error
	...
	static var ClientError:Range<HTTPStatusCode.RawValue> {
		get {
			return Range(start: HTTPStatusCode.BadRequest_400.rawValue, end: HTTPStatusCode.ClientClosedRequest_TokenRequired_499.rawValue)
		}
	}
...
// MARK: - 5xx Server-Error
	...
	static var ServerError:Range<HTTPStatusCode.RawValue> {
		get {
			return Range(start: HTTPStatusCode.InternalServerError_500.rawValue, end: HTTPStatusCode.NetworkConnectTimeoutError_599.rawValue)
		}
	}
}

extension Range {
	var startValue:Element {
		get {
