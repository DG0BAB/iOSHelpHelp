...
extension UIColor {
	...
	class func colorWithWebColor(_ webColorString: String, alpha: CGFloat) -> UIColor? {
		...
		Scanner(string: red).scanHexInt32(&redValue); Scanner(string: green).scanHexInt32(&greenValue); Scanner(string: blue).scanHexInt32(&blueValue)
...
extension Array where Element: Equatable {
	mutating func removeObject(object: Array.Iterator.Element) {
